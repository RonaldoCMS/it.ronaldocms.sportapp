...
import 'package:football/app/home/player/player_view_model.dart';
...
//Text("${data[index].statistics!.goals!.total}
  ...
  Widget futureList(
    ...
    List<Result_Player> data = snapshot.data;
  ...
  Widget table(List<Result_Player> data) {
